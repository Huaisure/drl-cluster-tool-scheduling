...
def test_deadlock_is_reported_without_a_safety_shield() -> None:
    ...
    # Pick A although its destination is full. This is intentionally legal;
    # after Pick completes the single-arm Robot cannot resolve the cycle.
    observation, *_ = env.step(0)
